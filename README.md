...
General:
- Returns a list of categories, success value and total category
...
**GET /questions**
General:
- Returns a list of question, success value, total question and categories
...
General:
- Deletes the question of the given ID if it exists. Returns success value, deleted question id, total_questions and list of questions.
